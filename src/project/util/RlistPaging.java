...
public RlistPaging(int nowPage, int rowTotal, 
...
if(isPrePage) {
sb.append("<li class='page-item'><a class='page-link' href='rlist.inc?nowPage=");
...
if(i == nowPage) {
	...
	sb.append("<li class='page-item'><a class='page-link btn-light' href='rlist.inc?nowPage=");
	sb.append(i);//파라미터 값
