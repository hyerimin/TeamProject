...
public MyEventPaging(int nowPage, int rowTotal, 
...
// StringBuffer에 저장하자!
sb = new StringBuffer("<ol class='paging' style='margin-left : 40%;'>");

if(isPrePage) {
sb.append("<li><a href='myEvent?nowPage=");
