...
public class RClistPaging {
	
	private String r_idx;
	
	private int nowPage, 
	rowTotal, //총 댓글 수 
	blockList, //한 페이지에 표현할 댓글 수 
...
public RClistPaging(String r_idx, int nowPage, int rowTotal, 
...
if(isPrePage) {
sb.append("<li class='page-item'><a class='page-link' href=rdetail?nowPage=");
sb.append(nowPage - blockPage);
sb.append("'> Previous </a></li>");
}else {
//이전기능 비활성화
sb.append("<li class='page-item disable'><a class='page-link btn-danger' href='#' tabindex='-1'> Previous </a></li>");
}
...
if(i == nowPage) {
	sb.append("<li class='page-item'><a class='page-link btn-primary'>");
	sb.append(i);
	sb.append("</a></li>");
}else {
	sb.append("<li class='page-item'><a class='page-link btn-light' href='rdetail?r_idx='");
	sb.append(r_idx);//파라미터 값
	sb.append("&nowPage=");
	sb.append(i);//파라미터 값
...
sb.append("<li class='page-item disable'><a class='page-link btn-danger' href='#' tabindex='-1'> Next </a></li>");
}
sb.append("</ul>");
}//생성자의 끝!
